 ...
 * \file change.php
 * 
 * Файл-обработчик выхода из комнаты. Файл удаляет cookie комнаты и переносит пользователя на запрашиваемую страницу.
 * 
 * \todo Переписать файл, чтобы был читаемым 
 * \todo Обработчик не удаляет cookie
 */
