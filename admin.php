 ...
 * \file admin.php
 * 
 * Файл играет роль страницы администрирования для людей с правами админа, либо суперадмина. Здесь они могут забанить, разбанить, либо повысить других юзеров до статуса админа
 */
?>
